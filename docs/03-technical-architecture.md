...
| `PROJECT_COMPLETED` | Project Management | Billing (triggers final invoice), Integrations (syncs final job cost to QuickBooks) |
| `INVOICE_PAID` | Billing | Project Management (unlocks next milestone, if gated) |
